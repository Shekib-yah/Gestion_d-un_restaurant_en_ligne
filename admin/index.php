...
<?php include('partials/menu.php'); ?>
        ...
        <div class="main-content">
            <div class="wrapper">
                <h1 style="text-align: center;">Panneau de configuration administrateur système</h1>
                <br><br>
                <?php 
                ...
                <div class="col-4 text-center">
                    ...
                    <br />Commandes en cours de livraison
                </div>
                ...
                <div class="col-4 text-center">
                    ...
                    <br />
                    Administrateurs système enregistrés  
                </div>
